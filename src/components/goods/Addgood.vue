      ...
      >
        ...
        >
          ...
          <el-tab-pane label="商品参数" name="1">
            ...
            >
              <el-checkbox-group v-model="item.attr_vals">
                <el-checkbox
                  :label="supItem"
                  v-for="(supItem, index) in item.attr_vals"
                  :key="index"
                  border
                ></el-checkbox>
              </el-checkbox-group>
          ...
          <el-tab-pane label="商品内容" name="4">
            ...
            <el-button class="btn" @click="add">添加</el-button>
          </el-tab-pane>
        </el-tabs>
      </el-form>
    </el-card>
...
export default {
  ...
  data() {
    return {
      // 步骤条活跃标签 stepss中保存的是Number类型, tabs中保存的字符串类型
      activeIndex: "0",
      //tabs方向
      tabPosition: "left",
      //增加的表单数据
  ...
  methods: {
    ...
    beforeTabLeave(actievName, oldActiveName) {
      // console.log(actievName,oldActiveName);
    ...
    async tabClicked() {
      ...
      if (this.activeIndex === "1") {
        ...
        if (res.meta.status !== 200) {
          return this.$message.error("获取动静态属性列表失败");
        }
        console.log(res.data);
